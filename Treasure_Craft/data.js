...
const ITEMS = [
    ...
    { id: 7, lv: 1, name: "木の剣", type: 1, stat: 10, price: 60, prob: 0 },
    { id: 8, lv: 1, name: "木の盾", type: 2, stat: 5, price: 30, prob: 0 },
    { id: 9, lv: 1, name: "木の胸当て", type: 3, stat: 15, price: 90, prob: 0 },
    { id: 10, lv: 1, name: "きれいな石", type: 7, stat: 0, price: 20, prob: 4 },
    { id: 11, lv: 1, name: "石の指輪", type: 4, stat: 5, price: 100, prob: 0 },
    ...
    // --- Lv2: 銅の鉱山 ---
    { id: 24, lv: 2, name: "銅鉱石", type: 7, stat: 0, price: 20, prob: 9 },
    { id: 25, lv: 2, name: "銅", type: 6, stat: 0, price: 50, prob: 0 },
    { id: 26, lv: 2, name: "銅の剣", type: 1, stat: 30, price: 200, prob: 0 },
    { id: 27, lv: 2, name: "銅の盾", type: 2, stat: 15, price: 100, prob: 0 },
    { id: 28, lv: 2, name: "銅の鎧", type: 3, stat: 45, price: 300, prob: 0 },
    { id: 29, lv: 2, name: "アメジスト原石", type: 7, stat: 0, price: 50, prob: 4 },
    { id: 30, lv: 2, name: "アメジスト", type: 6, stat: 0, price: 120, prob: 0 },
    { id: 31, lv: 2, name: "紫水晶の指輪", type: 4, stat: 15, price: 350, prob: 0 },
    ...
    // --- Lv3: 鉄の岩壁 ---
    { id: 44, lv: 3, name: "鉄鉱石", type: 7, stat: 0, price: 60, prob: 8 },
    { id: 45, lv: 3, name: "鉄", type: 6, stat: 0, price: 150, prob: 0 },
    { id: 46, lv: 3, name: "鉄の剣", type: 1, stat: 80, price: 600, prob: 0 },
    { id: 47, lv: 3, name: "鉄の盾", type: 2, stat: 40, price: 300, prob: 0 },
    { id: 48, lv: 3, name: "鉄の鎧", type: 3, stat: 120, price: 900, prob: 0 },
    { id: 49, lv: 3, name: "サファイア原石", type: 7, stat: 0, price: 150, prob: 3 },
    { id: 50, lv: 3, name: "サファイア", type: 6, stat: 0, price: 350, prob: 0 },
    { id: 51, lv: 3, name: "蒼玉の指輪", type: 4, stat: 40, price: 1000, prob: 0 },
    ...
    // --- Lv4: 銀の廃都 ---
    { id: 64, lv: 4, name: "銀鉱石", type: 7, stat: 0, price: 150, prob: 7 },
    { id: 65, lv: 4, name: "銀", type: 6, stat: 0, price: 400, prob: 0 },
    { id: 66, lv: 4, name: "銀の剣", type: 1, stat: 200, price: 1600, prob: 0 },
    { id: 67, lv: 4, name: "銀の盾", type: 2, stat: 100, price: 800, prob: 0 },
    { id: 68, lv: 4, name: "銀の鎧", type: 3, stat: 300, price: 2400, prob: 0 },
    { id: 69, lv: 4, name: "エメラルド原石", type: 7, stat: 0, price: 400, prob: 3 },
    { id: 70, lv: 4, name: "エメラルド", type: 6, stat: 0, price: 900, prob: 0 },
    { id: 71, lv: 4, name: "翠玉の指輪", type: 4, stat: 100, price: 2600, prob: 0 },
    ...
    // --- Lv5: 黄金の神殿 ---
    { id: 84, lv: 5, name: "金鉱石", type: 7, stat: 0, price: 400, prob: 6 },
    { id: 85, lv: 5, name: "金", type: 6, stat: 0, price: 1000, prob: 0 },
    { id: 86, lv: 5, name: "金の剣", type: 1, stat: 500, price: 4000, prob: 0 },
    { id: 87, lv: 5, name: "金の盾", type: 2, stat: 250, price: 2000, prob: 0 },
    { id: 88, lv: 5, name: "金の鎧", type: 3, stat: 750, price: 6000, prob: 0 },
    { id: 89, lv: 5, name: "ルビー原石", type: 7, stat: 0, price: 1000, prob: 2 },
    { id: 90, lv: 5, name: "ルビー", type: 6, stat: 0, price: 2200, prob: 0 },
    { id: 91, lv: 5, name: "紅玉の指輪", type: 4, stat: 250, price: 6400, prob: 0 },
    ...
    // --- Lv6: 天空の砦 ---
    { id: 104, lv: 6, name: "ミスリル鉱石", type: 7, stat: 0, price: 1000, prob: 5 },
    { id: 105, lv: 6, name: "ミスリル", type: 6, stat: 0, price: 2500, prob: 0 },
    { id: 106, lv: 6, name: "ミスリルソード", type: 1, stat: 1200, price: 10000, prob: 0 },
    { id: 107, lv: 6, name: "ミスリルシールド", type: 2, stat: 600, price: 5000, prob: 0 },
    { id: 108, lv: 6, name: "ミスリルメイル", type: 3, stat: 1800, price: 15000, prob: 0 },
    { id: 109, lv: 6, name: "ダイヤ原石", type: 7, stat: 0, price: 2500, prob: 2 },
    { id: 110, lv: 6, name: "ダイヤモンド", type: 6, stat: 0, price: 5500, prob: 0 },
    { id: 111, lv: 6, name: "金剛石の指輪", type: 4, stat: 600, price: 16000, prob: 0 },
    ...
    // --- Lv7: 竜の火口 ---
    { id: 124, lv: 7, name: "オリハルコン鉱石", type: 7, stat: 0, price: 3000, prob: 4 },
    { id: 125, lv: 7, name: "オリハルコン", type: 6, stat: 0, price: 8000, prob: 0 },
    { id: 126, lv: 7, name: "究極の剣", type: 1, stat: 3000, price: 32000, prob: 0 },
    { id: 127, lv: 7, name: "究極の盾", type: 2, stat: 1500, price: 16000, prob: 0 },
    { id: 128, lv: 7, name: "究極の鎧", type: 3, stat: 4500, price: 48000, prob: 0 },
    { id: 129, lv: 7, name: "虹色の結晶", type: 7, stat: 0, price: 8000, prob: 1 },
    { id: 130, lv: 7, name: "虹色の宝石", type: 6, stat: 0, price: 18000, prob: 0 },
    { id: 131, lv: 7, name: "虹の指輪", type: 4, stat: 1500, price: 54000, prob: 0 },
